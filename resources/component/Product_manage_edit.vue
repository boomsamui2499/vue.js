        ...
        <form action="/product_manage">
            <div class="create-form">
                ...
                <!-- <select v-model="cataget">
                    <option v-for="catagory in catagorys" :key="catagory.catagory_id">{{catagory.catagory_name}}</option>
                </select> -->
                <br>
                <button class="btn btn-success" style="text-align:center;">บันทึก</button>
            </div>
        </form>
...
export default {
    ...
    methods: {
        getCatagoryData() {
            axios.get('/catagory').then(responce=>{
